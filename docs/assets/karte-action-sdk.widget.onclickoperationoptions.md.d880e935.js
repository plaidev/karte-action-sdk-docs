import{_ as s,c as n,o as a,a as l}from"./app.62578bba.js";const F=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":2,"title":"widget.OnClickOperationOptions variable","slug":"widget-onclickoperationoptions-variable","link":"#widget-onclickoperationoptions-variable","children":[]}],"relativePath":"karte-action-sdk.widget.onclickoperationoptions.md"}'),o={name:"karte-action-sdk.widget.onclickoperationoptions.md"},p=l(`<p><a href="./">Home</a> &gt; <a href="./karte-action-sdk.html">@plaidev/karte-action-sdk</a> &gt; <a href="./karte-action-sdk.widget.html">widget</a> &gt; <a href="./karte-action-sdk.widget.onclickoperationoptions.html">OnClickOperationOptions</a></p><h2 id="widget-onclickoperationoptions-variable" tabindex="-1">widget.OnClickOperationOptions variable <a class="header-anchor" href="#widget-onclickoperationoptions-variable" aria-hidden="true">#</a></h2><p><strong>Signature:</strong></p><div class="language-typescript"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#FFCB6B;">OnClickOperationOptions</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> readonly [</span></span>
